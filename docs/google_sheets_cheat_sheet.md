...
the notebook), `reporting-automation-spec.md` (the decisions-and-why
doc), and `cheat_sheet.md` (interview prep, built once the dashboard was
complete). This document is now complete — the dashboard build (KPI
